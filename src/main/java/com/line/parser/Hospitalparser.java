...
public class Hospitalparser implements Parser<Hospital> {
    ...
    public Hospital parse(String str) {
        ...
        return new Hospital(splitted[0], splitted[1], splitted[2], Integer.parseInt(splitted[6]), splitted[10], splitted[7]);
    }
}
